    ...
    def search(self, endpoint, fileloc, params={}):
        ...
        while True:
            ...
            for item in resp.response:
                ...
                if item.get('message'):
                    print(item.get('message')) # TODO - log this instead of just printing, to see what went wrong
                    continue
            ...
            self.results = [result for page in self.results if page for result in page]
